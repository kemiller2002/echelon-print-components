...
const components = {
  ...
  "ef-print-bounded-sheet": { slug:"bounded-sheet", title:"Bounded Sheet", category:"Physical composition", capability:"P0 portable", maturity:"implemented", summary:"Opt-in fixed physical sheet for forms, entries, certificates, and one-page artifacts where the sheet boundary is part of the contract.", caution:"Use for genuinely bounded artifacts, not as a replacement for normal browser pagination.", examples:[{title:"Letter entry",note:"Header, bounded body, and footer retain logical source order.",html:`<ef-print-bounded-sheet><header data-sheet-header><h1>Competition Entry</h1></header><main data-sheet-body><p>Entry content</p></main><footer data-sheet-footer>Entrant details</footer></ef-print-bounded-sheet>`},{title:"A4 form",note:"A4 is a first-class physical profile.",html:`<ef-print-bounded-sheet size="a4"><header data-sheet-header><h1>Inspection Form</h1></header><main data-sheet-body><p>Inspection findings</p></main><footer data-sheet-footer>Signed</footer></ef-print-bounded-sheet>`},{title:"One-page summary",note:"Bounded composition is useful beyond recipes.",html:`<ef-print-bounded-sheet><header data-sheet-header><h1>Executive Summary</h1></header><main data-sheet-body><p>Decision-ready summary content.</p></main><footer data-sheet-footer>Confidential</footer></ef-print-bounded-sheet>`},{title:"State Fair recipe entry",note:"A full Letter competition sheet uses the bounded-sheet primitive with an authored adaptive fit region.",html:`<ef-print-bounded-sheet class="state-fair-entry"><header data-sheet-header><h1>Indiana State Fair Recipe Entry</h1><dl><div><dt>Division</dt><dd>Culinary Arts</dd></div><div><dt>Class</dt><dd>Recipe</dd></div><div><dt>Entry</dt><dd>2026</dd></div></dl></header><main data-sheet-body><ef-print-fit-region profiles="base compact columns tiny micro"><h2>Recipe title</h2><h3>Ingredients</h3><ul><li>Ingredient one</li><li>Ingredient two</li><li>Ingredient three</li></ul><h3>Method</h3><p>Prepare, combine, bake, and finish according to the submitted recipe.</p></ef-print-fit-region></main><footer data-sheet-footer>Entrant · County · Entry number</footer></ef-print-bounded-sheet>`}] },

  "ef-print-fit-region": { slug:"fit-region", title:"Fit Region", category:"Physical composition", capability:"P0 + opt-in measurement", maturity:"implemented", summary:"Chooses the least aggressive authored CSS profile that fits a bounded region without inventing layout values.", caution:"This is a narrow measured-layout exception for bounded artifacts. If no authored profile fits, status is overflow and content remains visible.", examples:[{title:"Density escalation",note:"Authors define what each named profile means in CSS.",html:`<ef-print-fit-region profiles="base compact dense"><h2>Summary</h2><p>Content remains semantic while authored profiles control density.</p></ef-print-fit-region>`},{title:"Column escalation",note:"A later profile may opt into multiple columns through consumer CSS.",html:`<ef-print-fit-region profiles="single compact columns"><h2>Ingredients</h2><ul><li>Flour</li><li>Butter</li><li>Sugar</li></ul></ef-print-fit-region>`},{title:"Explicit failure",note:"Failure is exposed rather than hidden clipping.",html:`<ef-print-fit-region profiles="base compact"><p>Bounded content reports whether an authored profile actually fits.</p></ef-print-fit-region>`}] },
  ...
  "ef-print-security-record": {slug:"security-record",title:"Security Evidence Record",category:"Security",capability:"P0 portable",maturity:"implemented",summary:"Tutela assessment record preserving posture, scope, unknowns and evidence.",caution:"A record reports scoped evidence; it does not certify general security.",examples:[{title:"Blocked assessment",note:"Unknowns remain visible.",html:`<ef-print-security-record><h1>Security Evidence Record</h1><p>Posture: BLOCKED</p></ef-print-security-record>`},{title:"Conditional assessment",note:"Conditions remain part of the printed record.",html:`<ef-print-security-record><h1>Security Evidence Record</h1><p>Posture: CONDITIONAL</p><p>Condition: complete authorization review.</p></ef-print-security-record>`},{title:"Scoped pass",note:"Scope is explicit rather than implying universal security.",html:`<ef-print-security-record><h1>Security Evidence Record</h1><p>Posture: PASS</p><p>Scope: invoice export workflow.</p></ef-print-security-record>`}]},
  "ef-print-security-posture": {slug:"security-posture",title:"Security Posture",category:"Security",capability:"P0 portable",maturity:"implemented",summary:"Prints Tutela PASS, CONDITIONAL, BLOCKED or INDETERMINATE state.",caution:"Never interpret PASS as a general security guarantee.",examples:[{title:"Indeterminate",note:"Required evidence is incomplete.",html:`<ef-print-security-posture data-posture="INDETERMINATE"><strong>INDETERMINATE</strong></ef-print-security-posture>`},{title:"Conditional",note:"A qualified posture keeps its condition visible.",html:`<ef-print-security-posture data-posture="CONDITIONAL"><strong>CONDITIONAL</strong><p>Pending control verification.</p></ef-print-security-posture>`},{title:"Blocked",note:"A blocking posture is unmistakable in print.",html:`<ef-print-security-posture data-posture="BLOCKED"><strong>BLOCKED</strong><p>Required evidence is absent.</p></ef-print-security-posture>`}]},
  "ef-print-security-invariant": {slug:"security-invariant",title:"Security Invariant",category:"Security",capability:"P0 portable",maturity:"implemented",summary:"Prints an invariant and its evidenced state.",caution:"Stable invariant IDs must be preserved.",examples:[{title:"Verified invariant",note:"Evidence is explicit.",html:`<ef-print-security-invariant id="SEC-INV-001"><h2>SEC-INV-001</h2><p>Verified</p></ef-print-security-invariant>`},{title:"Unverified invariant",note:"Unverified state remains explicit.",html:`<ef-print-security-invariant id="SEC-INV-002"><h2>SEC-INV-002</h2><p>Unverified</p></ef-print-security-invariant>`},{title:"Invariant with evidence",note:"Stable identity and evidence can be printed together.",html:`<ef-print-security-invariant id="SEC-INV-003"><h2>SEC-INV-003</h2><p>Verified by SEC-EVD-014.</p></ef-print-security-invariant>`}]},
  "ef-print-security-evidence": {slug:"security-evidence",title:"Security Evidence",category:"Security",capability:"P0 portable",maturity:"implemented",summary:"Prints an evidence reference and provenance.",caution:"Sensitive evidence is redacted by default.",examples:[{title:"Evidence reference",note:"Reference remains traceable.",html:`<ef-print-security-evidence data-evidence-id="SEC-EVD-001">SEC-EVD-001</ef-print-security-evidence>`},{title:"Evidence with provenance",note:"A source remains visible without exposing sensitive payloads.",html:`<ef-print-security-evidence data-evidence-id="SEC-EVD-002"><strong>SEC-EVD-002</strong><p>Source: automated authorization test.</p></ef-print-security-evidence>`},{title:"Redacted evidence",note:"Sensitive material can be represented without disappearing from the record.",html:`<ef-print-security-evidence data-evidence-id="SEC-EVD-003"><strong>SEC-EVD-003</strong><p>Payload redacted; provenance retained.</p></ef-print-security-evidence>`}]},
  "ef-print-security-unknown": {slug:"security-unknown",title:"Unknown Security Effect",category:"Security",capability:"P0 portable",maturity:"implemented",summary:"Makes unresolved security knowledge explicit in print.",caution:"Unknowns must not be visually suppressed.",examples:[{title:"Open unknown",note:"Shows evidence still required.",html:`<ef-print-security-unknown id="SEC-UNK-001"><h2>SEC-UNK-001</h2><p>Authorization behavior not established.</p></ef-print-security-unknown>`},{title:"Boundary unknown",note:"Unknown behavior at a system boundary remains explicit.",html:`<ef-print-security-unknown id="SEC-UNK-002"><h2>SEC-UNK-002</h2><p>Cross-service token propagation is not established.</p></ef-print-security-unknown>`},{title:"Evidence-needed unknown",note:"The record states what would resolve the uncertainty.",html:`<ef-print-security-unknown id="SEC-UNK-003"><h2>SEC-UNK-003</h2><p>Needs production-like replay evidence.</p></ef-print-security-unknown>`}]},
  "ef-print-security-exception": {slug:"security-exception",title:"Security Exception",category:"Security",capability:"P0 portable",maturity:"implemented",summary:"Prints approved exception scope, controls and expiry.",caution:"Expired exceptions cannot satisfy a gate.",examples:[{title:"Active exception",note:"Expiry remains explicit.",html:`<ef-print-security-exception id="SEC-EXC-001"><h2>SEC-EXC-001</h2><p>Expires 1 Oct 2026</p></ef-print-security-exception>`},{title:"Compensating control",note:"Approved controls remain attached to the exception.",html:`<ef-print-security-exception id="SEC-EXC-002"><h2>SEC-EXC-002</h2><p>Control: manual approval on every export.</p><p>Expires 15 Oct 2026</p></ef-print-security-exception>`},{title:"Expired exception",note:"An expired exception stays visible and cannot silently satisfy a gate.",html:`<ef-print-security-exception id="SEC-EXC-003"><h2>SEC-EXC-003</h2><p>Status: expired</p><p>Expired 1 Sep 2026</p></ef-print-security-exception>`}]}
};
